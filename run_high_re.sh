...
python simulations/cavity_flow/cavity_flow.py --re $RE --nx $NX --nt $NT --dt $DT --benchmark --output-dir outputs/high_re
deactivate
...
python simulations/cavity_flow/cavity_flow_jax.py --re $RE --nx $NX --nt $NT --dt $DT --benchmark --output-dir outputs/high_re
deactivate
...
source venv/bin/activate
python simulations/cavity_flow/compare_solutions.py --input-dir outputs/high_re --output solutions_comparison_re1000.png
deactivate
